...
#define CONTROL_DEFAULT_UP(x)         ((JOY_LIST_FIRST + 1) + (JOY_MAX_INPUTS * (x)))
#define CONTROL_DEFAULT_RIGHT(x)      ((JOY_LIST_FIRST + 2) + (JOY_MAX_INPUTS * (x)))
#define CONTROL_DEFAULT_DOWN(x)       ((JOY_LIST_FIRST + 3) + (JOY_MAX_INPUTS * (x)))
#define CONTROL_DEFAULT_LEFT(x)       ((JOY_LIST_FIRST + 4) + (JOY_MAX_INPUTS * (x)))
#define CONTROL_DEFAULT_FIRE1(x)      ((JOY_LIST_FIRST + 5) + (JOY_MAX_INPUTS * (x)))
#define CONTROL_DEFAULT_FIRE2(x)      ((JOY_LIST_FIRST + 6) + (JOY_MAX_INPUTS * (x)))
#define CONTROL_DEFAULT_FIRE3(x)      ((JOY_LIST_FIRST + 7) + (JOY_MAX_INPUTS * (x)))
#define CONTROL_DEFAULT_FIRE4(x)      ((JOY_LIST_FIRST + 8) + (JOY_MAX_INPUTS * (x)))
#define CONTROL_DEFAULT_FIRE5(x)      ((JOY_LIST_FIRST + 9) + (JOY_MAX_INPUTS * (x)))
#define CONTROL_DEFAULT_FIRE6(x)      ((JOY_LIST_FIRST + 10) + (JOY_MAX_INPUTS * (x)))
#define CONTROL_DEFAULT_START(x)      ((JOY_LIST_FIRST + 11) + (JOY_MAX_INPUTS * (x)))
#define CONTROL_DEFAULT_SCREENSHOT(x) ((JOY_LIST_FIRST + 12) + (JOY_MAX_INPUTS * (x)))
#define CONTROL_DEFAULT_ESC(x)        ((JOY_LIST_FIRST + 15) + (JOY_MAX_INPUTS * (x)))
