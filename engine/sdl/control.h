...
#include "joysticks.h"
	...
	#define	CONTROL_DEFAULT1_FIRE3      (JOY_LIST_FIRST + 2) + 1    // X
	#define	CONTROL_DEFAULT1_FIRE4      (JOY_LIST_FIRST + 3) + 1    // Y
	#define	CONTROL_DEFAULT1_FIRE5      (JOY_LIST_FIRST + 8) + 1    // ZL
	#define	CONTROL_DEFAULT1_FIRE6      (JOY_LIST_FIRST + 9) + 1    // ZR
