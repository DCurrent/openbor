...
static void set_default_controller_mappings(InputDevice *device)
{
    ...
    device->mappings[SDID_ATTACK2]    = SDL_CONTROLLER_BUTTON_Y;
    device->mappings[SDID_ATTACK3]    = SDL_CONTROLLER_BUTTON_RIGHTSHOULDER;
    device->mappings[SDID_ATTACK4]    = SDL_CONTROLLER_BUTTON_LEFTSHOULDER;
    device->mappings[SDID_JUMP]       = SDL_CONTROLLER_BUTTON_B;
    device->mappings[SDID_SPECIAL]    = SDL_CONTROLLER_BUTTON_X;
    device->mappings[SDID_START]      = SDL_CONTROLLER_BUTTON_START;
    device->mappings[SDID_SCREENSHOT] = SDL_CONTROLLER_BUTTON_BACK;
    device->mappings[SDID_ESC]        = SDL_CONTROLLER_BUTTON_GUIDE;
}
...
static void set_default_joystick_mappings(InputDevice *device)
{
    ...
    device->mappings[SDID_ATTACK2]    = 2;
    device->mappings[SDID_ATTACK3]    = 5;
    device->mappings[SDID_ATTACK4]    = 4;
    device->mappings[SDID_JUMP]       = 1;
    device->mappings[SDID_SPECIAL]    = 3;
