...
#define LIST_ADD(y,z) List_InsertAfter(result, (void*) y, z)
    ...
    LIST_ADD(CMD_MODEL_FOLLOW_CONDITION_ACTING_ANIMATION_EXCLUDE, "follow_condition_acting_animation_exclude");
    LIST_ADD(CMD_MODEL_FOLLOW_CONDITION_ACTING_ANIMATION_REQUIRE, "follow_condition_acting_animation_require");
    LIST_ADD(CMD_MODEL_FOLLOW_CONDITION_ACTING_DIRECTION_EXCLUDE, "follow_condition_acting_direction_exclude");
    LIST_ADD(CMD_MODEL_FOLLOW_CONDITION_ACTING_DIRECTION_REQUIRE, "follow_condition_acting_direction_require");
    LIST_ADD(CMD_MODEL_FOLLOW_CONDITION_ACTING_FLAG_FALSE, "follow_condition_acting_flag_false");
    LIST_ADD(CMD_MODEL_FOLLOW_CONDITION_ACTING_FLAG_TRUE, "follow_condition_acting_flag_true");
    LIST_ADD(CMD_MODEL_FOLLOW_CONDITION_ACTING_FRAME_MAX, "follow_condition_acting_frame_max");
    LIST_ADD(CMD_MODEL_FOLLOW_CONDITION_ACTING_FRAME_MIN, "follow_condition_acting_frame_min");
    LIST_ADD(CMD_MODEL_FOLLOW_CONDITION_ACTING_HEIGHT_MAX, "follow_condition_acting_height_max");
    LIST_ADD(CMD_MODEL_FOLLOW_CONDITION_ACTING_HEIGHT_MIN, "follow_condition_acting_height_min");
    LIST_ADD(CMD_MODEL_FOLLOW_CONDITION_ACTING_HP_MAX, "follow_condition_acting_hp_max");
    LIST_ADD(CMD_MODEL_FOLLOW_CONDITION_ACTING_HP_MIN, "follow_condition_acting_hp_min");
    LIST_ADD(CMD_MODEL_FOLLOW_CONDITION_ACTING_HP_RATIO_MAX, "follow_condition_acting_hp_ratio_max");
    LIST_ADD(CMD_MODEL_FOLLOW_CONDITION_ACTING_HP_RATIO_MIN, "follow_condition_acting_hp_ratio_min");
    LIST_ADD(CMD_MODEL_FOLLOW_CONDITION_ACTING_KEY_EXCLUDE, "follow_condition_acting_key_exclude");
    LIST_ADD(CMD_MODEL_FOLLOW_CONDITION_ACTING_KEY_REQUIRE, "follow_condition_acting_key_require");
    LIST_ADD(CMD_MODEL_FOLLOW_CONDITION_ACTING_TYPE_EXCLUDE, "follow_condition_acting_type_exclude");
    LIST_ADD(CMD_MODEL_FOLLOW_CONDITION_ACTING_TYPE_REQUIRE, "follow_condition_acting_type_require");
    LIST_ADD(CMD_MODEL_FOLLOW_CONDITION_OTHER_ANIMATION_EXCLUDE, "follow_condition_other_animation_exclude");
    LIST_ADD(CMD_MODEL_FOLLOW_CONDITION_OTHER_ANIMATION_REQUIRE, "follow_condition_other_animation_require");
    LIST_ADD(CMD_MODEL_FOLLOW_CONDITION_OTHER_DIRECTION_EXCLUDE, "follow_condition_other_direction_exclude");
    LIST_ADD(CMD_MODEL_FOLLOW_CONDITION_OTHER_DIRECTION_REQUIRE, "follow_condition_other_direction_require");
    LIST_ADD(CMD_MODEL_FOLLOW_CONDITION_OTHER_FLAG_FALSE, "follow_condition_other_flag_false");
    LIST_ADD(CMD_MODEL_FOLLOW_CONDITION_OTHER_FLAG_TRUE, "follow_condition_other_flag_true");
    LIST_ADD(CMD_MODEL_FOLLOW_CONDITION_OTHER_FRAME_MAX, "follow_condition_other_frame_max");
    LIST_ADD(CMD_MODEL_FOLLOW_CONDITION_OTHER_FRAME_MIN, "follow_condition_other_frame_min");
    LIST_ADD(CMD_MODEL_FOLLOW_CONDITION_OTHER_HEIGHT_MAX, "follow_condition_other_height_max");
    LIST_ADD(CMD_MODEL_FOLLOW_CONDITION_OTHER_HEIGHT_MIN, "follow_condition_other_height_min");
    LIST_ADD(CMD_MODEL_FOLLOW_CONDITION_OTHER_HP_MAX, "follow_condition_other_hp_max");
    LIST_ADD(CMD_MODEL_FOLLOW_CONDITION_OTHER_HP_MIN, "follow_condition_other_hp_min");
    LIST_ADD(CMD_MODEL_FOLLOW_CONDITION_OTHER_HP_RATIO_MAX, "follow_condition_other_hp_ratio_max");
    LIST_ADD(CMD_MODEL_FOLLOW_CONDITION_OTHER_HP_RATIO_MIN, "follow_condition_other_hp_ratio_min");
    LIST_ADD(CMD_MODEL_FOLLOW_CONDITION_OTHER_KEY_EXCLUDE, "follow_condition_other_key_exclude");
    LIST_ADD(CMD_MODEL_FOLLOW_CONDITION_OTHER_KEY_REQUIRE, "follow_condition_other_key_require");
    LIST_ADD(CMD_MODEL_FOLLOW_CONDITION_OTHER_TYPE_EXCLUDE, "follow_condition_other_type_exclude");
    LIST_ADD(CMD_MODEL_FOLLOW_CONDITION_OTHER_TYPE_REQUIRE, "follow_condition_other_type_require");
    LIST_ADD(CMD_MODEL_FOLLOW_INDEX, "follow_index");
