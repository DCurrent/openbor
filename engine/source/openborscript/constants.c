...
int mapstrings_transconst(ScriptVariant **varlist, int paramCount)
{
    ...
    if(varlist[0]->vt == VT_STR)
    {
        ...
        ICMPCONST(CHILD_SPAWN_CONFIG_GRAVITY_DISABLE)
        ICMPCONST(CHILD_SPAWN_CONFIG_THROW)
        ICMPCONST(CHILD_SPAWN_CONFIG_TOSS)
        ICMPCONST(CHILD_SPAWN_CONFIG_POSITION_ABSOLUTE)
        ICMPCONST(CHILD_SPAWN_CONFIG_POSITION_SCROLL)
        ICMPCONST(CHILD_SPAWN_CONFIG_SET_CHILD)
        ICMPCONST(CHILD_SPAWN_CONFIG_SET_OWNER)
        ICMPCONST(CHILD_SPAWN_CONFIG_SET_PARENT)
        ICMPCONST(CHILD_SPAWN_CONFIG_COPY_OFFENSE)
