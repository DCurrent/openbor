...
int mapstrings_transconst(ScriptVariant **varlist, int paramCount)
{
    ...
    if(varlist[0]->vt == VT_STR)
    {
        ...
        ICMPCONST(_ANIMATION_PROP_ANIMHITS)
        ICMPCONST(_ANIMATION_PROP_ANTIGRAV)
        ICMPCONST(_ANIMATION_PROP_ATTACK)
        ICMPCONST(_ANIMATION_PROP_COLLISIONONE)
        ICMPCONST(_ANIMATION_PROP_BODY_COLLISION)
        ICMPCONST(_ANIMATION_PROP_ENTITY_COLLISION)
        ICMPCONST(_ANIMATION_PROP_BOUNCE)
        ICMPCONST(_ANIMATION_PROP_CANCEL)
        ICMPCONST(_ANIMATION_PROP_CHARGETIME)
        ICMPCONST(_ANIMATION_PROP_COUNTERRANGE)
        ICMPCONST(_ANIMATION_PROP_DELAY)
        ICMPCONST(_ANIMATION_PROP_DRAWMETHODS)
        ICMPCONST(_ANIMATION_PROP_DROPFRAME)
        ICMPCONST(_ANIMATION_PROP_DROPV)
        ICMPCONST(_ANIMATION_PROP_ENERGYCOST)
        ICMPCONST(_ANIMATION_PROP_FLIPFRAME)
        ICMPCONST(_ANIMATION_PROP_FOLLOWUP)
        ICMPCONST(_ANIMATION_PROP_IDLE)
        ICMPCONST(_ANIMATION_PROP_INDEX)
        ICMPCONST(_ANIMATION_PROP_JUMPFRAME)
        ICMPCONST(_ANIMATION_PROP_LANDFRAME)
        ICMPCONST(_ANIMATION_PROP_LOOP)
        ICMPCONST(_ANIMATION_PROP_MODEL_INDEX)
        ICMPCONST(_ANIMATION_PROP_MOVE)
        ICMPCONST(_ANIMATION_PROP_NUMFRAMES)
        ICMPCONST(_ANIMATION_PROP_OFFSET)
        ICMPCONST(_ANIMATION_PROP_PLATFORM)
        ICMPCONST(_ANIMATION_PROP_PROJECTILE)
        ICMPCONST(_ANIMATION_PROP_QUAKEFRAME)
        ICMPCONST(_ANIMATION_PROP_RANGE)
        ICMPCONST(_ANIMATION_PROP_SHADOW)
        ICMPCONST(_ANIMATION_PROP_SIZE)
        ICMPCONST(_ANIMATION_PROP_SOUNDTOPLAY)
        ICMPCONST(_ANIMATION_PROP_SPAWNFRAME)
        ICMPCONST(_ANIMATION_PROP_SPRITE)
        ICMPCONST(_ANIMATION_PROP_SPRITEA)
        ICMPCONST(_ANIMATION_PROP_SUBENTITY)
        ICMPCONST(_ANIMATION_PROP_SUMMONFRAME)
        ICMPCONST(_ANIMATION_PROP_SYNC)
        ICMPCONST(_ANIMATION_PROP_UNSUMMONFRAME)
        ICMPCONST(_ANIMATION_PROP_VULNERABLE)
        ICMPCONST(_ANIMATION_PROP_WEAPONFRAME)
