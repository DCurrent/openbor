...
int mapstrings_transconst(ScriptVariant **varlist, int paramCount)
{
    ...
    if(varlist[0]->vt == VT_STR)
    {
        ...
        */
		...
		ICMPCONST(FOLLOW_CONFIG_NONE)		
		ICMPCONST(FOLLOW_CONDITION_GENERAL_BLOCK_FALSE)
		ICMPCONST(FOLLOW_CONDITION_GENERAL_BLOCK_TRUE)
		ICMPCONST(FOLLOW_CONDITION_GRAB_FALSE)
		ICMPCONST(FOLLOW_CONDITION_GRAB_TRUE)
		ICMPCONST(FOLLOW_CONDITION_HOSTILE_FALSE)
		ICMPCONST(FOLLOW_CONDITION_HOSTILE_TRUE)
		ICMPCONST(FOLLOW_CONDITION_HOSTILE_FALSE)
		ICMPCONST(FOLLOW_CONDITION_HOSTILE_TRUE)
		ICMPCONST(FOLLOW_CONDITION_GENERAL_LETHAL_FALSE)
		ICMPCONST(FOLLOW_CONDITION_GENERAL_LETHAL_TRUE)
        */
