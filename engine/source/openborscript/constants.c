...
int mapstrings_transconst(ScriptVariant **varlist, int paramCount)
{
    ...
    if(varlist[0]->vt == VT_STR)
    {
        ...
        ICMPCONST(CHILD_SPAWN_CONFIG_RELATIONSHIP_CHILD)
        ICMPCONST(CHILD_SPAWN_CONFIG_RELATIONSHIP_OWNER)
        ICMPCONST(CHILD_SPAWN_CONFIG_RELATIONSHIP_PARENT)
        ICMPCONST(CHILD_SPAWN_CONFIG_TYPE_TARGET_PARENT)
