...
int mapstrings_transconst(ScriptVariant **varlist, int paramCount)
{
    ...
    if(varlist[0]->vt == VT_STR)
    {
		...
		ICMPCONST(BIND_OVERRIDE_FRAME_SET_LAND)
        ...
        ICMPCONST(DRAWMETHOD_PROPERTY_BACKGROUND_TRANSPARENCY)
