...
bool mapstrings_transconst(ScriptVariant **varlist, int paramCount)
{
    ...
    if(varlist[0]->vt == VT_STR)
    {
        ...
        */ 
        ...
        /* WebM playback object property access. */
        ICMPCONST(WEBM_PROPERTY_ACTIVE)
        ICMPCONST(WEBM_PROPERTY_CHANNEL)
        ICMPCONST(WEBM_PROPERTY_DISPLAY_MODE)
        ICMPCONST(WEBM_PROPERTY_DURATION)
        ICMPCONST(WEBM_PROPERTY_HEIGHT)
        ICMPCONST(WEBM_PROPERTY_INTERRUPT)
        ICMPCONST(WEBM_PROPERTY_LOADING)
        ICMPCONST(WEBM_PROPERTY_OFFSET_X)
        ICMPCONST(WEBM_PROPERTY_OFFSET_Y)
        ICMPCONST(WEBM_PROPERTY_PAUSED)
        ICMPCONST(WEBM_PROPERTY_POSITION)
        ICMPCONST(WEBM_PROPERTY_REPEAT)
        ICMPCONST(WEBM_PROPERTY_SCREEN)
        ICMPCONST(WEBM_PROPERTY_SOUND_CHANNEL)
        ICMPCONST(WEBM_PROPERTY_SPEED)
        ICMPCONST(WEBM_PROPERTY_WIDTH)
        ICMPCONST(WEBM_PROPERTY_END)
#ifdef WEBM
        ICMPCONST(WEBM_PLAYBACK_CHANNEL_COUNT)
        ICMPCONST(WEBM_PLAYBACK_CHANNEL_AUTO)
        ICMPCONST(WEBM_DISPLAY_CLIP)
        ICMPCONST(WEBM_DISPLAY_FILL)
        ICMPCONST(WEBM_DISPLAY_END)
        ICMPCONST(WEBM_LOADING_STREAM)
        ICMPCONST(WEBM_LOADING_CACHE)
        ICMPCONST(WEBM_LOADING_END)
#endif
