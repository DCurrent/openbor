...
int mapstrings_transconst(ScriptVariant **varlist, int paramCount)
{
    ...
    if(varlist[0]->vt == VT_STR)
    {
        ...
        ICMPCONST(CHILD_SPAWN_CONFIG_BEHAVIOR_NORMAL)
        ICMPCONST(CHILD_SPAWN_CONFIG_BEHAVIOR_PROJECTILE)
        ICMPCONST(CHILD_SPAWN_CONFIG_CANDAMAGE_PARAMETER)
        ICMPCONST(CHILD_SPAWN_CONFIG_CANDAMAGE_PARENT)
        ICMPCONST(CHILD_SPAWN_CONFIG_COLOR_PARENT_INDEX)
        ICMPCONST(CHILD_SPAWN_CONFIG_COLOR_PARENT_TABLE)
        ICMPCONST(CHILD_SPAWN_CONFIG_GRAVITY_OFF)
        ICMPCONST(CHILD_SPAWN_CONFIG_GRAVITY_ON)
        ICMPCONST(CHILD_SPAWN_CONFIG_HOSTILE_PARAMETER)
        ICMPCONST(CHILD_SPAWN_CONFIG_HOSTILE_PARENT)
        ...
        ICMPCONST(CHILD_SPAWN_CONFIG_POSITION_ABSOLUTE)
        ICMPCONST(CHILD_SPAWN_CONFIG_POSITION_LEVEL)
        ICMPCONST(CHILD_SPAWN_CONFIG_PROJECTILEHIT_PARAMETER)
        ICMPCONST(CHILD_SPAWN_CONFIG_PROJECTILEHIT_PARENT)
        ...
        */
        ...
        ICMPCONST(SPAWN_TYPE_CHILD_BOMB)
        ICMPCONST(SPAWN_TYPE_CHILD_NORMAL)
        ICMPCONST(SPAWN_TYPE_CHILD_PROJECTILE)
