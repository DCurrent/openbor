...
int mapstrings_transconst(ScriptVariant **varlist, int paramCount)
{
    ...
    if(varlist[0]->vt == VT_STR)
    {
        ...
        ICMPCONST(BINDING_MATCHING_ANIMATION_MATCH)
        ICMPCONST(BINDING_MATCHING_FRAME_MATCH)
        ICMPCONST(BINDING_MATCHING_ANIMATION_KILL)
        ICMPCONST(BINDING_MATCHING_FRAME_KILL)
