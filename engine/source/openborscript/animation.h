...
typedef enum
{
	_ANIMATION_PROP_ANIMHITS,		
	_ANIMATION_PROP_ANTIGRAV,	
	_ANIMATION_PROP_COLLISIONONE, 
	_ANIMATION_PROP_BOUNCE,       
	_ANIMATION_PROP_CANCEL,      
	_ANIMATION_PROP_CHARGETIME,   
	_ANIMATION_PROP_COUNTERRANGE, 	
