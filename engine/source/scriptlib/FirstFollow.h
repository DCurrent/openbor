...
static MY_TOKEN_TYPE follow[] =
{
    ...
    /*decl_list*/ EPSILON, TOKEN_LCURLY, TOKEN_IF, TOKEN_SWITCH, TOKEN_WHILE, TOKEN_DO, TOKEN_FOR, TOKEN_BREAK, TOKEN_CONTINUE, TOKEN_RETURN, TOKEN_INC_OP, TOKEN_DEC_OP, TOKEN_BITWISE_NOT, TOKEN_ADD, TOKEN_SUB, TOKEN_BOOLEAN_NOT, TOKEN_IDENTIFIER, TOKEN_HEXCONSTANT, TOKEN_INTCONSTANT, TOKEN_FLOATCONSTANT, TOKEN_STRING_LITERAL, TOKEN_LPAREN, TOKEN_RCURLY, TOKEN_CASE, TOKEN_DEFAULT, END_OF_TOKENS,
    /*decl_list2*/ EPSILON, TOKEN_LCURLY, TOKEN_IF, TOKEN_SWITCH, TOKEN_WHILE, TOKEN_DO, TOKEN_FOR, TOKEN_BREAK, TOKEN_CONTINUE, TOKEN_RETURN, TOKEN_INC_OP, TOKEN_DEC_OP, TOKEN_BITWISE_NOT, TOKEN_ADD, TOKEN_SUB, TOKEN_BOOLEAN_NOT, TOKEN_IDENTIFIER, TOKEN_HEXCONSTANT, TOKEN_INTCONSTANT, TOKEN_FLOATCONSTANT, TOKEN_STRING_LITERAL, TOKEN_LPAREN, TOKEN_RCURLY, TOKEN_CASE, TOKEN_DEFAULT, END_OF_TOKENS,
