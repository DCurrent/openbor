...
typedef enum
{
    BINDING_ANIMATION_MATCHING_NONE            = 0,
    BINDING_ANIMATION_MATCHING_ANIMATION_MATCH = 1,
    BINDING_ANIMATION_MATCHING_FRAME_MATCH     = 2,
    BINDING_ANIMATION_MATCHING_ANIMATION_KILL  = 4,
    BINDING_ANIMATION_MATCHING_FRAME_KILL      = 6
} e_binding_animation;
