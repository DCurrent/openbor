...
#define CONTROL_DEFAULT_FIRE2(x)      (7+(18*(x)))
#define CONTROL_DEFAULT_FIRE3(x)      (9+(18*(x)))
#define CONTROL_DEFAULT_FIRE4(x)      (10+(18*(x)))
#define CONTROL_DEFAULT_FIRE5(x)      (6+(18*(x)))
#define CONTROL_DEFAULT_FIRE6(x)      (8+(18*(x)))
#define CONTROL_DEFAULT_START(x)      (11+(18*(x)))
#define CONTROL_DEFAULT_SCREENSHOT(x) 73
