...
char * palette_table_multiply(char *pal){
	...
	lut = (char*)tracemalloc("palette_table_multiply", 256*256);
...
char * palette_table_screen(char *pal){
	...
	lut = (char*)tracemalloc("palette_table_screen", 256*256);
	if(lut==NULL) return NULL;
...
char * palette_table_overlay(char *pal){
	...
	lut = (char*)tracemalloc("palette_table_overlay", 256*256);
	if(lut==NULL) return NULL;
...
char * palette_table_hardlight(char *pal){
	...
	lut = (char*)tracemalloc("palette_table_hardlight", 256*256);
	if(lut==NULL) return NULL;
...
char * palette_table_dodge(char *pal){
	...
	lut = (char*)tracemalloc("palette_table_dodgs", 256*256);
	if(lut==NULL) return NULL;
...
char * palette_table_half(char *pal){
	...
	lut = (char*)tracemalloc("palette_table_half", 256*256);
	if(lut==NULL) return NULL;
